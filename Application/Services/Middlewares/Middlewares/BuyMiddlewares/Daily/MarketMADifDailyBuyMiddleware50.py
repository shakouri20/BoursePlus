...
class marketMADifDailyBuyMiddleware50(middleware):

    def __init__(self, dataHandler, marketWatchHandler, mainTickersList: list, kargs):
        super(marketMADifDailyBuyMiddleware50, self).__init__(dataHandler, marketWatchHandler, mainTickersList, kargs)
    ...
    def get_online_data(self, tickersList: list, dataHandler: onlineDataHandler, marketWatchHandler:marketWatchDataHandler):
        ...
        marketMADif = marketWatchHandler.lastPricePRCAverge_MA_dif(num= 1, maLength= 50)
