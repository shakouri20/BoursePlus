...
class realPowerCapitaBuyStrategy(middleware_organizer):
    def __init__(self, name):
        super(realPowerCapitaBuyStrategy, self).__init__(name)
    ...
    def configure(self):
        ...
        self.use_middleware('realPowerCapitaBuyMiddleware', name='RealPowerCapitaMiddleware', weight= 1, jitMode = True)

    def get_strategy_name():
        return 'realPowerCapitaBuyStrategy'
